...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-2)9^7e4%t@pkz68f^x4=n2sj7a-%^*v)eh4__hd28@+tefgt)f')
...
# Add all hosts for Railway internal networking or if specific domain is tricky
